...
// Mannhullet custom code (ref. Kristoffer A. Iversen, Petahz.no)

define('APPLICATION_PATH', realpath(dirname(__FILE__).'/../../../application'));

$zf_path = APPLICATION_PATH . '/../';
set_include_path($zf_path.PATH_SEPARATOR.$zf_path.'library/'.PATH_SEPARATOR.get_include_path());
require_once($zf_path.'/library/Zend/Loader/Autoloader.php');
